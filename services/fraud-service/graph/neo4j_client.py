"""One place to open a driver, reused by every script in this package -
mirrors how ``fraud_service/config.py`` centralises the Redis URL rather than
letting each caller build its own connection.
"""
...
def add_connection_args(parser: argparse.ArgumentParser) -> None:
    """Shared CLI flags so every script in this package accepts the same
    overrides, rather than each one growing its own slightly different set.
    """
